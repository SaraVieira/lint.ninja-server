  ...
  plugin.route([
    ...
    },
    {
      ...
      config: {
        ...
        validate: {
          params: {
            name: Joi.string().required().description('Linter name'),
            creator: Joi.string().required().description('Linter creator'),
            category: Joi.string().required().description('Linter category'),
            url: Joi.string().required().description('Linter url'),
    ...
    },
    {
      ...
      config: {
        ...
        validate: {
          params: {
            category: Joi.string().required().description('Search Category')
          }
        }
      }
    }
