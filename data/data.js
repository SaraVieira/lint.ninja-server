module.exports = [
  {
    ...
    "description": "Linter for Awesome lists. Intended to make it easier to create and maintain Awesome lists.",
  ...
  },
  {
    ...
    "description": "CSS static analysis written in Javascript. Uses pluggable rules.",
    "creator": "CSSLint",
    "category": "css"
  },
  {
    ...
    "description": "CSS tool that beautifies CSS based on a configuration. Helps with keeping CSS consistent. Written in Javascript.",
    "creator": "csscomb",
    "category": "css"
  },
  {
    ...
    "description": "Static analysis for Internet Explorer 8 compatibility. Written in Javascript.",
  ...
  },
  {
    ...
    "description": " Fully pluggable tool for identifying and reporting on patterns in JavaScript.",
    "creator": "eslint",
    "category": "javascript"
  },
  {
    ...
    "description": " Community-driven tool that detects errors and potential problems in JavaScript code.",
    "creator": "jshint",
    "category": "javascript"
  },
  {
    ...
    "description": "Opinionated JavaScript formatter inspired by refmt with advanced support for language features from ES2017, JSX, and Flow.",
    "creator": "jlongster",
    "category": "javascript"
  },
  {
  ...
  },
  {
    ...
    "description": "Configurable linter to enforce standards in npm package.json files.",
    "creator": "tclindner",
    "category": "random"
  },
  {
    ...
    "description": "Node.js style checker and lint tool for Markdown/CommonMark files.",
    "creator": "DavidAnson",
    "category": "markdown"
  },
  {
    ...
    "description": "Check markdown files and flag style issues. Written in ruby and is distributed as a rubygem.",
    "creator": "mivok",
    "category": "markdown"
  },
  {
    ...
    "description": "Written in Javascript. remark-lint provides configurable Markdown style linting.",
    "creator": "wooorm",
    "category": "markdown"
  },
  {
    ...
    "description": "Catch errors in your polymer project before even running your code. Written in TypeScript.",
    "creator": "PolymerLabs",
    "category": "javascript"
  },
  {
  ...
  },
  {
    ...
    "description": "Tool to help keep your SCSS files clean and readable by running it against a collection of configurable linter rules.",
    "creator": "causes",
    "category": "sass"
  },
  {
    ...
    "description": "Customizable TypeScript linter with automatic fixing of formating and style violations.",
    "creator": "palantir",
    "category": "typescript"
  },
  {
  ...
  },
  {
    ...
    "description": "HTMLHint is a Static Code Analysis Tool for HTML, you can use it with IDE or in build system.",
    "creator": "yaniswang",
    "category": "HTML"
  },
  {
    ...
    "description": "Bootlint is a tool that checks for several common HTML mistakes in webpages that are using Bootstrap.",
    "creator": "twbs",
    "category": "HTML"
  },
  {
  ...
  },
  {
    ...
    "description": "Wikimedia CSS Coding Standards shareable config for stylelint",
    "creator": "wikimedia",
    "category": "stylelint-config"
  },
  {
    ...
    "description": "WordPress CSS Coding Standards shareable config for stylelint",
    "creator": "ntwb",
    "category": "stylelint-config"
  },
  {
  ...
  },
  {
    ...
    "description": "stylelint plugin which requires or disallow an empty line before property groups.e",
    "creator": "hudochenkov",
    "category": "stylelint-plugin"
  },
  {
  ...
  },
  {
    ...
    "description": "A stylelint plugin to check the use of variables on declaration in (less/scss/css).",
    "creator": "sh-waqar",
    "category": "stylelint-plugin"
  },
  {
  ...
  },
  {
    ...
    "description": "A stylelint plugin that enforces either variables ($sass, @less, var(--cssnext)), functions or custom CSS keywords (inherit, none, etc.) for property's values.",
    "creator": "AndyOGo",
    "category": "stylelint-plugin"
  },
  {
